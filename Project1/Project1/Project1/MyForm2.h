...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label2->Text = L"Студент 31-ІПЗ групи";
			// 
			// label3
			// 
			...
			this->label4->Text = L"Глибовець Дмитро";
			// 
			// timer1
			// 
			...
			this->label5->Text = L"Скремблер для";
			// 
			// label6
			// 
			...
			this->label6->Text = L"шифру Цезаря";
			// 
			// MyForm2
			// 
